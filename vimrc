...
" Note: this will not work for C-style functions
...
let g:DoxygenToolkit_briefTag_pre="\<enter> * \\brief "
let g:DoxygenToolkit_blockHeader="---------------------------------------------------------------------\<enter>*       "
let g:DoxygenToolkit_header_funcName = "yes"
let g:DoxygenToolkit_post_funcName = "()\<enter>"
let g:DoxygenToolkit_insertModeAfterDox = "no"
let g:DoxygenToolkit_startCommentTag = "/*! "
let g:DoxygenToolkit_cinoptions = "C2C2"
...
if !exists("g:DoxygenToolkit_header_funcName")
	let g:DoxygenToolkit_header_funcName = "no"
endif

if !exists("g:DoxygenToolkit_insertModeAfterDox")
	let g:DoxygenToolkit_insertModeAfterDox = "yes"
endif

if !exists("g:DoxygenToolkit_post_funcName")
        let g:DoxygenToolkit_post_funcName = ""
endif
...
function! <SID>DoxygenCommentFunc()
	...
	if ( g:DoxygenToolkit_blockHeader != "" )
		" Add function name if required
		if ( g:DoxygenToolkit_header_funcName =~ "yes" )
			let l:beginP = 0
			let l:currentP = -1
			...
			exec "normal O" . g:DoxygenToolkit_startCommentBlock . g:DoxygenToolkit_blockHeader . l:name . g:DoxygenToolkit_post_funcName . g:DoxygenToolkit_endCommentBlock
	...
	if ( l:classDef == 1 )
		...
		if ( g:DoxygenToolkit_insertModeAfterDox != "no" )
		        startinsert!
		endif
		return
	endif
	...
	if ( g:DoxygenToolkit_briefTag_funcName =~ "yes" )
		...
		endwhile
		let l:name = strpart( l:lineBuffer, l:beginP, l:endP - l:beginP )
		exec "normal A" . l:name . g:DoxygenToolkit_post_funcName
	endif
